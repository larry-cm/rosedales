...
export function ChevronsCarousel({
    handleNextClick,
    handlePrevClick,
    buttonClass = 'focus:ring btn-effect ring-green-500 cursor-pointer rounded-2xl shadow',
    chevronClass = 'block  hover:stroke-zinc-300 backdrop-blur-md bg-green-500 text-white rounded-2xl size-8  md:size-10 hover:stroke-green-500 transition duration-300' }: TypeChevronsCarousel) {
    return (
